        ...
        \begin{scope}[local bounding box=A]
	      ...
	      % Letter
            ...
            \begin{scope}[shift={(A.center)}, inner sep=0pt]
                ...
                {\scriptsize
                \node[ket,anchor=south,above=1ex]            at  (1.center)  {$\left|+,\!n_{L}\!\!-\!\!1,\!n_{R}\!\!+\!\!1\right\rangle$};
                \node[ket,anchor=south,above=1ex]            at  (2.center) {$\left|-, n_{L}, n_{R}\right\rangle$};
                \node[ket,anchor=east]            at  (3.west)  {$\left|\alpha \sigma,\!n_{L}\!\!-\!\!1,\!n_{R}\!\!+\!\!1\right\rangle$};
                \node[ket,anchor=south,above=1ex]            at  (4.center)  {$\left|+,\!n_{L}\!\!-\!\!2,\!n_{R}\!\!+\!\!2\right\rangle$};
                \node[ket,anchor=north,below=1ex]            at  (5.center)  {$\left|-,\!n_{L}\!\!-\!\!1,\!n_{R}\!\!+\!\!1\right\rangle$};
                \node[ket,anchor=west]            at  (6.east)  {$\left|\alpha \sigma,\!n_{L}\!\!-\!\!2,\!n_{R}\!\!+\!\!2\right\rangle$};
                \node[ket,anchor=north,below=1ex] at  (7.center) {$\left|+,\!\textcolor{blue}{n_{L}\!\!-\!\!3},\! \textcolor{red}{n_{R}\!\!+\!\!3}\right\rangle$};
                \node[ket,anchor=north,below=1ex] at  (8.center)  {$\left|-, \!\textcolor{blue}{n_{L}\!\!-\!\!2},\!\textcolor{red}{n_{R}\!\!+\!\!2}\right\rangle$};
                }
